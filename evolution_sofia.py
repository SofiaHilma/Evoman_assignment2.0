...
from algorithms_sofia import Evolution
from plotting_funcs_sofia import plot_avg_fitness, plot_avg_diversity
...
for enemy_group in [enemy_group1, enemy_group2]:
    ...
    for run in range(1, n_runs + 1):
        ...
        end_time = time.time()
        triggered_diverse_time = end_time - start_time
        print(f'Triggered Diverse Algorithm completed in {triggered_diverse_time:.2f} seconds.')
        ...
        end_time = time.time()
        diverse_time = end_time -start_time
        print(f'Diverse Algorithm completed in {diverse_time:.2f} seconds.')
